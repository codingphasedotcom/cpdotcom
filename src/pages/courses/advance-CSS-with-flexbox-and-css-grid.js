...
import courseLogoIMG from '../../../assets/courses/flex_grid/course-logo.png'
          ...
          <div className="section-content">
            <div className="container">
              ...
              <div className="column">
                ...
                <ul>
                  <li>Learn to layout your pages easier</li>
                  <li>Verticaly align your items</li>
                  <li>Create your own grid</li>
                  <li>NO MORE BOOTSTRAP!!!</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="section-content">
            <div className="container">
              ...
              <div className="grid-container">
                <div className="column">
                  <h1>Media Queries</h1>
                  <p>We use all the things you need</p>
                </div>
                <div className="column">
...
const IndexPage = ({ data, location }) => {
  const pageData = data.coursesDataJson.data.filter(
    course => course.slug === 'advance-CSS-with-flexbox-and-css-grid'
  )[0]
