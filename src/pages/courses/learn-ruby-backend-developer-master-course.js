...
import courseLogoIMG from '../../../assets/courses/ruby/course-logo.png'
...
class Page extends Component {
  ...
  componentDidMount = () => {
    fbq('track', 'ViewContent', {
      ...
      currency: 'USD',
      content_ids: 'learn-ruby-backend-developer-master-course',
    })
    this.setState(
      {
...
const IndexPage = ({ data, location }) => {
  const pageData = data.coursesDataJson.data.filter(
    course => course.slug === 'learn-ruby-backend-developer-master-course'
  )[0]
  return (
    <Layout>
      <SEO
