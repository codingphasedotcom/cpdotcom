...
import courseLogoIMG from '../../../assets/courses/responsive_emails/course-logo.png'
import codeExampleIMG from '../../../assets/courses/responsive_emails/code-example.png'
import toolAtomIMG from '../../../assets/courses/responsive_emails/tool-atom.png'
import toolWorkbenchIMG from '../../../assets/courses/responsive_emails/tool-workbench.png'
import previewLaptopProject1IMG from '../../../assets/courses/responsive_emails/preview-laptop-project1.png'
import previewIphoneIMG from '../../../assets/courses/responsive_emails/iphone-preview.png'
import jumboBGIMG from '../../../assets/courses/responsive_emails/jumbobg.png'
        ...
        <section id="course-info">
          ...
          <div className="section-content">
            <div className="container">
              ...
              <div className="column">
                <h2>Responsive HTML Emails</h2>
                <ul>
                  <li>Convert designs with HTML emails</li>
...
export const query = graphql`
  query ResponsiveEmailsPageQuery {
    coursesDataJson {
      data {
        title
        price
